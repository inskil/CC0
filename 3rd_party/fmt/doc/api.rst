...
You can also reuse existing formatters, for example::
  ...
  struct fmt::formatter<color>: formatter<string_view> {
    ...
    auto format(color c, FormatContext &ctx) {
      string_view _name = "unknown";
      switch (c) {
      case color::red:   _name = "red"; break;
      case color::green: _name = "green"; break;
      case color::blue:  _name = "blue"; break;
      }
      return formatter<string_view>::format(_name, ctx);
    }
  };
...
You can also write a formatter for a hierarchy of classes::
  ...
  struct A {
    virtual ~A() {}
    virtual std::string _name() const { return "A"; }
  };

  struct B : A {
    virtual std::string _name() const { return "B"; }
  };
  ...
  struct fmt::formatter<T, std::enable_if_t<std::is_base_of<A, T>::value, char>> :
    ...
    auto format(const A& a, FormatCtx& ctx) {
      return fmt::formatter<std::string>::format(a._name(), ctx);
    }
  };
